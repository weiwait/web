...
<body>
    <div class="form">
        <form action="" method="post" id="sub" onsubmit="return sub();">
            <div>教　室: <input type="text" name="name"></div>
            <div>考勤机: <select name="attendance" id="mac">
                <?php if(is_array($machine)): foreach($machine as $key=>$machine): ?><option value="<?php echo ($machine['id']); ?>"><?php echo ($machine['mid']); ?></option><?php endforeach; endif; ?>
            </select></div>
