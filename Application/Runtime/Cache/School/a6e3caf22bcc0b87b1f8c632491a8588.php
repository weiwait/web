...
<body>
    <div class="form">
        <form action="" method="post" id="sub" onsubmit="return sub();">
            <div>课程: <input type="text" name="name"></div>
            <div>讲师: <select name="teacher" id="teacher">
                <?php if(is_array($teacher)): foreach($teacher as $key=>$teacher): ?><option value="<?php echo ($teacher['id']); ?>"><?php echo ($teacher['name']); ?></option><?php endforeach; endif; ?>
            </select></div>
